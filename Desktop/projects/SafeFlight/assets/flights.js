var tokenBtn = document.querySelector("#searchBtn");
var flightsEl = document.querySelector(".resultbox-wrap")
    ...
    fetch("https://test.api.amadeus.com/v2/shopping/flight-offers?originLocationCode=" + originCode + "&destinationLocationCode=" + destCode + "&departureDate=" + departDate + "&returnDate=" + returnDate + "&adults=1&max=5", requestOptions)
        ...
        .then(function(response) {
            ...
            for (i = 0; i < response.data.length; i++) {
                ...
                var pricesEl = document.createElement("span");
                pricesEl.textContent = ticketPrices[i].title;
                flightsEl.appendChild(pricesEl);
            };
